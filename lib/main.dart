      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "messages": [
            {
              "role": "system",
              "content": "You are an elite Autonomous Flutter AI Agent. Generate clean, complete, and production-ready Flutter code for main.dart based on the user prompt. Return ONLY valid Dart code without markdown formatting blocks if possible, or clean code."
            },
            {
              "role": "user",
              "content": userPrompt
...
''';
  ...
  // रीप्लेट जैसा स्मार्ट फाइल सेलेक्टर (प्रॉम्प्ट की जरूरत के हिसाब से फाइलें चुनना)
  Future<Map<String, String>> _intelligentFileSelector(String prompt, String groqKey) async {
    _addLog('🧠 AI प्रॉम्प्ट का विश्लेषण कर रहा है और ऐप की जरूरत तय कर रहा है...');
    
    String mainDartCode = await _generateCodeWithGroq(groqKey, prompt);

    // यह चैक करना कि ऐप साधारण है या बड़ा एडिटर/यूटिलिटी टाइप है
    bool isAdvancedApp = prompt.toLowerCase().contains('editor') || 
                          prompt.toLowerCase().contains('camera') || 
                          prompt.toLowerCase().contains('video') || 
                          prompt.toLowerCase().contains('advanced');
...
''',
    ...
    // यदि यूजर ने एडिटर या एडवांस ऐप मांगा है, तभी नेटिव ग्रैडल और मैनिफेस्ट जोड़ें, वरना फालतू झंझट न रखें
    if (isAdvancedApp) {
      _addLog('⚙️ एडवांस/एडिटर ऐप detected: नेटिव कॉन्फ़िगरेशन फाइलें जोड़ी जा रही हैं...');
